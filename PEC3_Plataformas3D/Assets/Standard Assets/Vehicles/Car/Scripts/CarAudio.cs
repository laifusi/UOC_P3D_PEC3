...
namespace UnityStandardAssets.Vehicles.Car
{
    ...
    public class CarAudio : MonoBehaviour
    {
        ...
        private void StartSound()
        {
            ...
            // we put audio sources in the effects mixer
            m_LowAccel.outputAudioMixerGroup = mixerGroup;
            m_LowDecel.outputAudioMixerGroup = mixerGroup;
            m_HighAccel.outputAudioMixerGroup = mixerGroup;
            m_HighDecel.outputAudioMixerGroup = mixerGroup;
